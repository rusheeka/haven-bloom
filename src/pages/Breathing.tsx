...
export default function Breathing() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 pb-36 relative">
      <div className="absolute inset-0 bg-gradient-to-b from-calm/10 via-background to-background pointer-events-none" />
