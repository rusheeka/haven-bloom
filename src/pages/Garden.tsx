...
export default function Garden() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center px-6 pt-[8vh] pb-36 relative text-[#0c080a]/95 bg-[#ea80c9]">
      <div className="absolute inset-0 bg-gradient-to-b from-growth/10 via-background to-background pointer-events-none" />

      <div className="relative z-10 w-full max-w-md flex flex-col items-center">
        {/* Header */}
        <div className="w-full flex justify-between items-start mb-8">
          <div>
            <p className="text-xs font-ui text-primary-foreground">Welcome back,</p>
        ...
        <motion.div
          ...
          className="bg-growth/15 rounded-orb px-5 py-3 mb-6 text-center">
            ...
            <p className="text-sm font-ui text-secondary-foreground">
              🌿 Daily check-in complete! +1 petal
            </p>
          </motion.div>
        }
        ...
        <div className="w-full max-w-xs mb-10">
          <div className="flex justify-between text-xs font-ui text-muted-foreground mb-1.5">
            <span className="text-primary-foreground">{user.petals} petals</span>
            <span className="text-primary-foreground">Next stage</span>
          </div>
