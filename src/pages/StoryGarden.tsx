    ...
    <div className="min-h-screen page-gradient">
      ...
      <div className="pt-40 md:pt-36 pb-12 px-6 flex flex-col items-center min-h-[80vh]">
        <div className="w-full max-w-md flex flex-col items-center text-center my-auto">
          <h1 className="text-sm md:text-base font-display text-foreground mb-2 leading-loose">Story Garden</h1>
          ...
          <AnimatePresence>
            {showForm && (
              <motion.div
                ...
                className="mb-6 overflow-hidden w-full flex flex-col items-center"
              >
                <textarea
                  value={newStory}
                  ...
                  maxLength={500}
                  className="w-full h-28 bg-card/50 backdrop-blur-xl rounded-orb p-4 font-journal text-lg text-foreground placeholder:text-muted-foreground/40 border-none outline-none resize-none shadow-ceramic mb-3 text-left"
                />
                <motion.button
          ...
          <div className="flex flex-col gap-3 w-full">
            {allStories.map((story) => (
              <motion.div
                ...
                className="bg-card/50 backdrop-blur-xl rounded-orb p-5 shadow-ceramic text-left"
              >
